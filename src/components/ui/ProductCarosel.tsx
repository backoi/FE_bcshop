...
const ProductCarousel = ({ title }: any) => {
  return (
    <div className="py-2 bg-green-600 w-[700px] px-4">
      ...
      {/* <button className="mt-8 px-6 py-2 border border-gray-700 text-gray-800 rounded hover:bg-gray-100 transition">
